...
{B}╠╣ {W}├─┤│  ├┤ ├┴┐│ ││ │├┴┐{R}───{B}║║║{W}├┴┐├┤ 
{B}╚  {W}┴ ┴└─┘└─┘└─┘└─┘└─┘┴ ┴   {B}╩ ╩{W}└─┘└  ''')
    print('' + Back.GREEN + Fore.WHITE + '        Creator : NicoID         \033[00m')
    print('' + Back.BLUE + Fore.WHITE + '         Suport : Bezeer         \033[00m')
    print('' + Back.RED + Fore.WHITE + '        Youtube : Suhat Nico     \033[00m')
    print()
       ...
       with ThreadPoolExecutor(max_workers=100) as ex:
            for user in username:
                ...
                for x in bb:
                    ...
                    litpas.append('Kontol')
                    litpas.append('Anjing')
                    litpas.append('Tangerang')
                    litpas.append('Bandung')
